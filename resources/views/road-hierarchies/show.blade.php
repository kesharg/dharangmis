...
<div class="box box-info">
    <div class="box-header with-border">
        <a href="{{ action('RoadHierarchyController@index') }}" class="btn btn-info">{{ __('Back to List') }}</a>
    ...
    <div class="form-horizontal">
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::label(null, $roadHierarchy->name, ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('value', __('Value'), ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-3">
                    {!! Form::label(null, $roadHierarchy->value, ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
    </div>
